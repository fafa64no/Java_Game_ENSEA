...
public class Cfg {
    ...
    public final static int stoneColorsNb=4;
    public final static int stoneVariantsNb=8;

    public final static double noiseSeed=6.6260755;
    public final static int noiseSizeTerrainColor=512;
    public final static int noiseSizeTerrainVariant=8;
}
