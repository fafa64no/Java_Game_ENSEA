...
public abstract class Vehicle extends Character implements Target {
    ...
    public Vehicle(Vec2 position, String texturePath, int velocityMultiplier, IVec2 textureSize, double rotationSpeed) {
        super(position, texturePath, velocityMultiplier,textureSize);
        this.scale=new Vec2(1,1);
        this.rotationSpeed=rotationSpeed;
    }

    public Vehicle(Vec2 position, String texturePath, int velocityMultiplier, IVec2 textureSize, double rotationSpeed, Vec2 scale) {
        super(position, texturePath, velocityMultiplier,textureSize);
        this.scale=scale;
        this.rotationSpeed=rotationSpeed;
    }
    ...
    public Vehicle(Vec2 position, String texturePath, String deadTexturePath, int velocityMultiplier, IVec2 textureSize, double rotationSpeed, Vec2 scale) {
        super(position, texturePath, deadTexturePath, velocityMultiplier,textureSize);
        this.scale=scale;
        this.rotationSpeed=rotationSpeed;
    }
